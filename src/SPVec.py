...
class SPVecGraph(object):
    ...
    def get_average_degree(self):
        ...
        """
        return nx.degree(self.nx_G) / self.nx_G.number_of_nodes()
    ...
    def new_graph(self):
        ...
        with open('data/output.txt', "r") as f:
            ...
            f.close()
            np.savetxt("data/new_edgelist.txt", fmt="%d", X=edgelist, encoding='utf-8')
            # self.write_txt("new_edgelist.txt", edgelist)
    ...
    def build_corpus(self, G, num_paths, path_length, alpha=0,
        ...
        np.savetxt("data/walks.txt", fmt="%d", X=walks, encoding='utf-8')
        return walks
